...
class AfternoonSlots extends StatelessWidget {
  ...
  const AfternoonSlots({super.key, required this.controller});
  ...
  Widget build(BuildContext context) {
    return Column(
      ...
      children: [
        Text('Afternoon 7 slots', style: AppTextStyles.timeTitle),
        SizedBox(height: 15.h),
        Obx(() => Wrap(
          spacing: 12.w,
          runSpacing: 12.h,
          children: List.generate(controller.afternoonSlots.length, (i) {
            final slot = controller.afternoonSlots[i];
